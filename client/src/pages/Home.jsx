        ...
        <div className="  w-full  flex  pt-28 flex-col justify-start  items-center gap-4">
          <div className="flex md:flex-row flex-col items-center justify-center md:gap-10 gap-1">
            ...
            <div className=" flex justify-center items-center pt-1">
              <Link
                to="/jobs"
                className="font-semibold md:text-2xl text-lg blueCol  md:py-3 py-2 px-6 md:px-10 "
              >
                Browse Jobs
              </Link>
            </div>
                ...
                <div>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                    {allJobs && allJobs.length >= 4 ? (
                      <>
                        <Link
                          to={`/details/${allJobs[3]._id}`}
                          className="flex gap-2 shadow-sm shadow-gray-800 border border-gray-700 w-full p-2 flex-col hover:border-rose-500 transition duration-300 hover:scale-[1.02] hover:bg-slate-950"
                        >
                          <div className="flex gap-3 justify-center items-center">
                            <div className="w-[5rem] flex justify-center items-center">
                              <img
                                src={allJobs[3].companyLogo.url}
                                alt={allJobs[3].title}
                                className="w-[4rem]"
                              />
                            </div>
                          ...
                          <div className="flex text-sm gap-4 flex-wrap justify-center">
                            <span>
                              {convertDateFormat(
                        ...
                        <Link
                          to={`/details/${allJobs[2]._id}`}
                          className="flex gap-2 shadow-sm shadow-gray-800 border border-gray-700 w-full p-2 flex-col hover:border-rose-500 transition duration-300 hover:scale-[1.02] hover:bg-slate-950"
                        >
                          <div className="flex gap-3 justify-center items-center">
                            <div className="w-[5rem] flex justify-center items-center">
                              <img
                                src={allJobs[2].companyLogo.url}
                                alt={allJobs[2].title}
                                className="w-[4rem]"
                              />
                            </div>
