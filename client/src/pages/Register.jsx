          ...
          <form onSubmit={registerHandler} className='flex flex-col md:w-1/3 shadow-gray-700  w-full md:mx-0 mx-8' action="">
            ...
            <div className='md:px-10 px-2 pt-4 pb-20 w-full flex flex-col gap-4'>
              ...
              <div className='bg-white flex justify-center items-center'>
                ...
                <input value={name} onChange={(e)=>setName(e.target.value)} required placeholder='Full name' type="text" className='outline-none w-full text-black px-1 pr-3 py-2' />
              </div>
              ...
              <div className='bg-white flex justify-center items-center'>
                ...
                <input value={email} onChange={(e)=>setEmail(e.target.value)} required placeholder='Email' type="email" className='outline-none w-full text-black px-1 pr-3 py-2' />
              </div>
              ...
              <div className='bg-white flex justify-center items-center'>
                ...
                <input value={password} onChange={(e)=>setPassword(e.target.value)} required placeholder='Password' type={eyeTog ? "text" : "password"} className='outline-none w-full text-black px-1 pr-3 py-2' />
              ...
              <div className='bg-white flex justify-center items-center'>
               ...
               { avatarName.length === 0 ? <span className='text-gray-400'>Select Profile Pic...</span>
                  : avatarName}
                </label>
             ...
             <div className='bg-white flex justify-center items-center'>
               ...
               { resumeName.length === 0 ?  <span className='text-gray-400 cursor-pointer'>Select Resume...</span> : resumeName}
                </label>
                <input required  
              ...
              <div className='bg-white flex justify-center items-center'>
                ...
                <textarea value={skills} onChange={(e)=>setSkills(e.target.value)} placeholder='Skills' type="text" className='outline-none w-full text-black px-1 pr-3 py-2' />
              </div>
