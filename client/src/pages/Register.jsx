      ...
      <div className="bg-gray-950 min-h-screen pt-14 md:px-20 px-3  text-white">
        <div className=" flex justify-center w-full items-start pt-6">
          <form
            ...
            className="flex flex-col md:w-1/3 shadow-gray-700  w-full md:mx-0 mx-8"
            action=""
          >
            <div className="md:px-10 px-2 pt-4 pb-20 w-full flex flex-col gap-4">
              ...
              <div className=" flex justify-center items-center border-b-2 border-gray-600">
                ...
                <input
                  ...
                  type="text"
                  className="outline-none bold-placeholder w-full text-white px-1 pr-3 py-2 bg-[#030712]"
                />
              </div>
              ...
              <div>
                <div className=" flex justify-center items-center border-b-2 border-gray-600">
                  ...
                  <label
                    htmlFor="avatar"
                    className="outline-none w-full cursor-pointer text-white px-1 pr-3 py-2 "
                  >
                    {avatarName.length === 0 ? (
                  ...
                  <input
                    ...
                    accept="image/*"
                    type="file"
                    className="outline-none  w-full hidden text-white px-1 pr-3 py-2"
                  />
                </div>
              ...
              <div>
                <div className=" flex justify-center items-center border-b-2 border-gray-600">
                  ...
                  <label
                    className="outline-none w-full text-white px-1 pr-3 py-2"
                    htmlFor="resume"
                  >
                    {resumeName.length === 0 ? (
                  ...
                  <input
                    ...
                    accept="image/*"
                    type="file"
                    className="outline-none hidden w-full text-white px-1 pr-3 py-2 bg-[#030712]"
                  />
                </div>
                <p className="bg-gray-950 text-white text-xs">
                  Please select Image file
              ...
              {/* Skills */}
              <div
                className="bg-[#030712] border-2 border-gray-600 rounded-md flex justify-center items-center"
                onClick={() => skillsRef.current?.focus()}
              >
                ...
                <textarea
                  ...
                  placeholder="Skills"
                  type="text"
                  className="outline-none w-full text-white bold-placeholder px-1 pr-3 py-2 bg-[#030712] "
                />
              </div>
