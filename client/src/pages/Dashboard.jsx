      ...
      <div className='bg-gray-950 min-h-screen pt-14  md:px-20 px-3  text-white'>
        ...
        <div>
          <div className=' pt-8 flex justify-center items-center  text-4xl'>
            <p className='pb-3 border-b border-gray-600 text-center w-1/2'>Dashboard</p>
          </div>

          <div className='grid md:grid-cols-3 grid-cols-1 md:gap-0 gap-16 md:pt-28 pt-16 pb-40'>
