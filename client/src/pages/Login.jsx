          ...
          <form onSubmit={loginHandler} className='flex flex-col md:w-1/3 shadow-gray-700  w-full md:mx-0 mx-8' action="">
            ...
            <div className='md:px-10 px-2 py-6 w-full flex flex-col gap-4'>
              ...
              <div className='bg-white flex justify-center items-center'>
                ...
                <input onChange={(e)=>setEmail(e.target.value)} value={email} required  placeholder='Email' type="text" className='outline-none w-full text-black px-1 pr-3 py-2' />
              </div>
              ...
              <div className='bg-white flex justify-center items-center'>
                ...
                <input onChange={(e)=>setPassword(e.target.value)} value={password} required placeholder='Password' type={eyeTog?"text":"password"} className='outline-none w-full text-black px-1 pr-3 py-2' />
